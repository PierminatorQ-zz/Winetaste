...
class WinestrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winestrain" do
    assert_difference('Winestrain.count') do
      post winestrains_url, params: { winestrain: { percentage: @winestrain.percentage, strain_id: @winestrain.strain_id, wine_id: @winestrain.wine_id } }
    end
  ...
  test "should update winestrain" do
    patch winestrain_url(@winestrain), params: { winestrain: { percentage: @winestrain.percentage, strain_id: @winestrain.strain_id, wine_id: @winestrain.wine_id } }
